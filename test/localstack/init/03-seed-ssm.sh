...
UBUNTU_X86_AMI=$(jq -r '.ami_ids["ubuntu-22.04-x86_64"]' /tmp/prism-localstack-config.json)
UBUNTU_ARM_AMI=$(jq -r '.ami_ids["ubuntu-22.04-arm64"]' /tmp/prism-localstack-config.json)
...
ROCKY_X86_AMI=$(jq -r '.ami_ids["rockylinux-9-x86_64"]' /tmp/prism-localstack-config.json)
ROCKY_ARM_AMI=$(jq -r '.ami_ids["rockylinux-9-arm64"]' /tmp/prism-localstack-config.json)
...
AL2023_X86_AMI=$(jq -r '.ami_ids["amazonlinux-2023-x86_64"]' /tmp/prism-localstack-config.json)
AL2023_ARM_AMI=$(jq -r '.ami_ids["amazonlinux-2023-arm64"]' /tmp/prism-localstack-config.json)
...
DEBIAN_X86_AMI=$(jq -r '.ami_ids["debian-12-x86_64"]' /tmp/prism-localstack-config.json)
DEBIAN_ARM_AMI=$(jq -r '.ami_ids["debian-12-arm64"]' /tmp/prism-localstack-config.json)
