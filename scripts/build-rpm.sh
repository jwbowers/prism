...
print_header() {
    echo -e "${BOLD}${BLUE}╔══════════════════════════════════════════════════════════════════════════════╗${NC}"
    echo -e "${BOLD}${BLUE}║                     Prism RPM Package Builder                     ║${NC}"
    echo -e "${BOLD}${BLUE}╠══════════════════════════════════════════════════════════════════════════════╣${NC}"
...
build_binaries() {
    ...
    eval "go build $ldflags -o bin/prism ./cmd/prism"
    ...
    # Verify binaries
    if [[ ! -x "bin/prism" ]] || [[ ! -x "bin/prismd" ]]; then
...
print_build_summary() {
    ...
    echo "   4. Test: prism --version && prism templates"
    echo ""
}
...
main() {
    ...
    while [[ $# -gt 0 ]]; do
        case $1 in
            --help|-h)
                echo "Prism RPM Package Builder"
                echo ""
