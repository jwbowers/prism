...
// NOTE: NewMemoryUserStorage() and NewUserManagementService() implementations
// have been moved to memory_storage.go and memory_service.go respectively
// to provide real working implementations instead of stubs
